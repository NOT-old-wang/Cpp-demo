...
class UserRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grpc_demo.service.UserRequest) */ {
 public:
  UserRequest();
  virtual ~UserRequest();
  ...
  // @@protoc_insertion_point(class_scope:grpc_demo.service.UserRequest)
 private:
...
class UserResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grpc_demo.service.UserResponse) */ {
 public:
  UserResponse();
  ...
  // @@protoc_insertion_point(class_scope:grpc_demo.service.UserResponse)
 private:
...
inline void UserRequest::set_name(const char* value, size_t size) {
...
// string name = 1;
inline void UserResponse::clear_name() {
  name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& UserResponse::name() const {
  // @@protoc_insertion_point(field_get:grpc_demo.service.UserResponse.name)
  return name_.GetNoArena();
}
inline void UserResponse::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:grpc_demo.service.UserResponse.name)
}
#if LANG_CXX11
inline void UserResponse::set_name(::std::string&& value) {
...
inline ::google::protobuf::int32 UserResponse::id() const {
  // @@protoc_insertion_point(field_get:grpc_demo.service.UserResponse.id)
  return id_;
}
inline void UserResponse::set_id(::google::protobuf::int32 value) {
...
// int32 age = 3;
inline void UserResponse::clear_age() {
  age_ = 0;
}
inline ::google::protobuf::int32 UserResponse::age() const {
  // @@protoc_insertion_point(field_get:grpc_demo.service.UserResponse.age)
  return age_;
}
inline void UserResponse::set_age(::google::protobuf::int32 value) {
...
#if LANG_CXX11
inline void UserResponse::set_sex(::std::string&& value) {
...
#endif
inline void UserResponse::set_sex(const char* value) {
  GOOGLE_DCHECK(value != NULL);
...
inline void UserResponse::set_sex(const char* value, size_t size) {
...
inline ::std::string* UserResponse::mutable_sex() {
...
inline ::std::string* UserResponse::release_sex() {
...
inline void UserResponse::set_allocated_sex(::std::string* sex) {
  if (sex != NULL) {
